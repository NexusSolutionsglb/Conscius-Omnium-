 ...
 * a portrait stays portrait, a landscape stays landscape — and sits in the
 * shared `.u-artframe` treatment: a paper mount and a layered drop shadow,
 * so the work reads as a print on a wall rather than a flat card.
 */
export function ArtworkCard({ work, priority = false }: { work: Work; priority?: boolean }) {
  ...
  return (
    <motion.article variants={fadeUp} className="group/art mb-8 break-inside-avoid sm:mb-10">
      ...
      >
        <div className="u-artframe u-artframe--lift relative p-2.5 pb-5">
          <ArtImage
            src={work.coverImage}
