...
--  (schema 0001–0005 + RLS + storage + the current gallery content)
--  Composed from: migrations/0001_init.sql, 0002_page_content.sql,
--  0003_site_chrome.sql, 0004_contact_emails.sql, 0005_newsletter.sql
--  and seed.sql — regenerate seed.sql first with
...
-- ═══════════════════════════════════════════════════════════════════
--  CONSCIUS OMNIUM — 0005 · newsletter + enquiry source
